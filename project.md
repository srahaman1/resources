...
You should come to class with a document that describes the main idea of your project. We will have about 10 minutes to meet with each team, so we ask that you come to the meeting without your laptop, but with a printed version of your document. You should designate one of the two team members to take notes. In addition to the printed document, you should also have posted this proposal to your project GitHub repository. Your document should contain the seven sections listed below. We don't expect this proposal to be 20 pages long, but the more detail you provide here the better help and feedback when can provide your team (both during our face-to-face meeting and after the fact):
